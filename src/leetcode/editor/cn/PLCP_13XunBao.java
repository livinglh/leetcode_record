...
//java:寻宝
public class PLCP_13XunBao{
    public static void main(String[] args) {
        Solution solution = new PLCP_13XunBao().new Solution();
    }
                ...
                for (int k = 0; k < ns; k++) {
                    ...
                    if (dd[i][midX][midY] != -1 && startDist[midX][midY] != -1) {
                        if (tmp == -1 || tmp > dd[i][midX][midY] + startDist[midX][midY]) {
                            // 从该i机关到某个石头堆的距离 + 从起点到该i机关的距离 = 该机关i到起点的距离
                    ...
                    for (int k = 0; k < ns; k++) {
                        ...
                        if (dd[i][midX][midY] != -1 && dd[j][midX][midY] != -1) {
                            if (mn == -1 || mn > dd[i][midX][midY] + dd[j][midX][midY]) {
                                // 从第i个机关到某个石头堆的距离 + 从第j个机关到某个石头堆的距离 = 第i个机关和第j个机关之间的距离
